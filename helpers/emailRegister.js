...
export const emailRegister = async (data) => {
  ...
  const info = await transport.sendMail({
    ...
    <p>Una vez confirmada, podrás comenzar a realizar un seguimiento de tus pacientes y mejorar tu administración de manera efectiva y más facil. Recuerda que lo que se registra es más fácil de medir y mejorar en el tiempo.</p> <img src="https://storage.googleapis.com/pai-images/3ebd348edae84eccb20edd385ec840cc.jpeg" alt="Psychologist on therapy" width="270" height="290">
    </div>`,
  });
